...
Gem::Specification.new do |s|
  s.name = "gomematic"
  s.version = Gomematic::Version
  s.date = Time.now.utc.strftime("%F")

  s.authors = ["Thomas Boerger"]
  s.email = ["thomas@webhippie.de"]
  s.summary = "lightweight and powerful homematic"
  s.description = "lightweight and powerful homematic"
  s.homepage = "https://github.com/gomematic/gomematic-ruby"
