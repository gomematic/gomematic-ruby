...
If unique, [open an issue](https://github.com/gomematic/gomematic-ruby/issues) and answer the questions so we can understand and reproduce the problematic behavior.
